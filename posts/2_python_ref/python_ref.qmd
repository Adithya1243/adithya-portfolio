...
- numpy arrays and lists are same for 1-D.
- numpy arrays are easier to write in 2-D
- Operations on all elements are performed at once. Its called broadcasting.
...
%timeit some_one_line_python_code
gives time taken to execute it. 

%%timeit
multiple_line_of_py-code
multiple_line_of_py-code
multiple_line_of_py-code
